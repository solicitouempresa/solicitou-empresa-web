...
[Demo](https://flatlogic.com/templates/solicitou-estabelecimento-web/demo) | [Download](https://github.com/flatlogic/solicitou-estabelecimento-web/archive/master.zip) | [Available versions](https://demo.flatlogic.com/solicitou-estabelecimento-web/) | [More templates](https://flatlogic.com/admin-dashboards) | [Support forum](https://flatlogic.com/forum)
...
```shell
$ git clone -o solicitou-estabelecimento-web -b master --single-branch \
      https://github.com/flatlogic/solicitou-estabelecimento-web.git MyApp
$ cd MyApp
```
